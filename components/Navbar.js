    ...
    return (
        <div className="drawer">
            ...
            <div className="drawer-content flex flex-col">
                {/* <!-- Navbar --> */}
                <div className="navbar bg-zinc-950 z-50 justify-between">
                    ...
                    <div className="flex-none hidden lg:block mr-10">
                        <ul className="menu menu-horizontal text-md">
                            ...
                            <li tabIndex={0}>
                                ...
                                <ul className="p-2 text-xs bg-zinc-950 drop-shadow-sm shadow-white z-50">
                    ...
                    {/* Search Bar */}
                    <div className="mr-2 flex flex-row justify-end lg:w-auto">
            ...
            <div className="drawer-side">
                ...
                <ul className="menu p-4 w-52 bg-zinc-950 drop-shadow-sm shadow-white">
                    ...
                    <li tabIndex={0}>
                        ...
                        <ul className="text-xs bg-zinc-950 drop-shadow-sm shadow-white z-50">
                        <li><Link href="/genre/action?id=28">Action</Link></li>
                                    <li><Link href="/genre/adventure?id=12">Adventure</Link></li>
                                    <li><Link href="/genre/animation?id=16">Animation</Link></li>
                                    <li><Link href="/genre/comedy?id=35">Comedy</Link></li>
